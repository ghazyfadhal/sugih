...
<?php $__env->startSection('header', 'Kelola Artikel / Berita'); ?>
...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="<?php echo e(route('admin.articles.create')); ?>" class="bg-sugih-green-900 text-sugih-gold px-5 py-2.5 rounded-xl font-semibold hover:bg-sugih-green-800 transition-colors flex items-center">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        <?php if($article->image): ?>
                            <img src="<?php echo e($article->image_url); ?>" class="w-24 h-16 object-cover rounded-lg border border-gray-200">
                        <?php else: ?>
                    ...
                    <td class="px-6 py-4">
                        <div class="font-semibold text-gray-800"><?php echo e($article->title); ?></div>
                        <div class="text-xs text-gray-400"><?php echo e($article->created_at->format('d M Y')); ?></div>
                    </td>
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="<?php echo e(route('admin.articles.edit', $article->id)); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
                            Edit
                        </a>
                        <form action="<?php echo e(route('admin.articles.destroy', $article->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus artikel ini?');">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SUGIH\sugih\resources\views/pages/admin/articles/index.blade.php ENDPATH**/ ?>