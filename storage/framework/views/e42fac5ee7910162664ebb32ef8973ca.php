...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="<?php echo e(route('admin.careers.create')); ?>" class="bg-black text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-gray-900 transition-colors flex items-center">
