...
<div x-data="productReorder(<?php echo e($products->firstItem() ?? 1); ?>)">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100" id="product-table-body">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors product-row bg-white" data-id="<?php echo e($product->id); ?>">
                        <td class="px-6 py-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->image): ?>
                                <img src="<?php echo e($product->image_url); ?>" class="w-16 h-16 object-cover rounded-lg border border-gray-200 shadow-sm">
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            ...
                            <div x-show="!reorderMode" class="inline-block">
                                <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium mr-4">
                                    Edit
                                </a>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('productReorder', (offset) => ({
            ...
            saveOrder() {
                ...
                fetch('<?php echo e(route('admin.products.updateOrder')); ?>', {
                    method: 'POST',
                    headers: {
