...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="<?php echo e(route('admin.products.create')); ?>" class="bg-black text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-gray-900 transition-colors flex items-center">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        <?php if($product->image): ?>
                            <img src="<?php echo e(Storage::url($product->image)); ?>" class="w-16 h-16 object-cover rounded-lg border border-gray-200">
                        <?php else: ?>
