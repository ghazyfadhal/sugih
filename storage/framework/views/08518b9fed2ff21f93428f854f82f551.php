    ...
    <section class="relative py-24 lg:py-28 overflow-hidden bg-sugih-base" data-testid="articles-section">
        ...
        <div class="container-page relative z-10">
            ...
            <div class="mt-14 text-center">
                <a href="<?php echo e(route('articles.index')); ?>" class="btn-primary" data-testid="all-articles-btn">
                    Lihat Semua Berita
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Code\Jokian\sugih\resources\views/pages/home/index.blade.php ENDPATH**/ ?>