...
<div class="mb-6 flex justify-between items-center">
    <div>
        <a href="<?php echo e(route('admin.articles.index')); ?>" class="text-sm text-gray-500 hover:text-black mb-2 inline-block">&larr; Kembali ke Daftar Artikel</a>
        <h2 class="text-xl font-bold text-gray-800">Form Edit Artikel</h2>
    </div>
</div>

<form action="<?php echo e(route('admin.articles.update', $article->id)); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-4xl">
    <?php echo csrf_field(); ?>
    ...
    <div class="space-y-6">
        <div>
            ...
            <input type="text" id="title" name="title" value="<?php echo e(old('title', $article->title)); ?>" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E6C981] focus:border-[#E6C981] outline-none transition-all">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea id="excerpt" name="excerpt" rows="2" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E6C981] focus:border-[#E6C981] outline-none transition-all"><?php echo e(old('excerpt', $article->excerpt)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea id="content" name="content" rows="10" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E6C981] focus:border-[#E6C981] outline-none transition-all"><?php echo e(old('content', $article->content)); ?></textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
            <div>
                ...
                <?php if($article->image): ?>
                    <img src="<?php echo e(Storage::url($article->image)); ?>" class="w-full h-48 object-cover rounded-xl border border-gray-200 mb-4">
                <?php else: ?>
            ...
            <div class="flex flex-col justify-center">
                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-100">
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_published" class="sr-only peer" <?php echo e($article->is_published ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SUGIH\sugih\resources\views/pages/admin/articles/edit.blade.php ENDPATH**/ ?>