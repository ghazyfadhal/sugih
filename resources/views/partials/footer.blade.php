<footer id="footer" class="bg-sugih-dark text-sugih-surface" data-testid="footer">
    <div class="container-page py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {{-- Alamat + Sosial Media --}}
        <div>
            <h4 class="heading-mark text-xl font-bold text-sugih-green mb-3">Alamat</h4>
            ...
            {{-- Sosial Media --}}
            <h4 class="heading-mark text-xl font-bold text-sugih-green mb-3 mt-8">Sosial Media</h4>
            <div class="flex items-center gap-5">
                <a href="https://www.facebook.com/share/17XFTLBsuN/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer"
                   aria-label="Facebook"
                   class="text-white/70 hover:text-sugih-green transition-colors">
        ...
        {{-- Kontak Kami --}}
        <div>
            <h4 class="heading-mark text-xl font-bold text-sugih-green mb-3">Kontak Kami</h4>
            <div class="text-base font-semibold leading-relaxed space-y-4">
                <div>
                    <span class="block text-white/70">Whatsapp:</span>
                    <a href="https://wa.me/628123456789" target="_blank" rel="noopener noreferrer"
                       class="inline-flex items-center gap-2 text-white hover:text-sugih-green transition-colors underline decoration-white/40 underline-offset-4 hover:decoration-sugih-green mt-1">
        ...
        {{-- Peta lokasi --}}
        <div>
            <h4 class="heading-mark text-xl font-bold text-sugih-green mb-3">Peta Lokasi</h4>
    ...
    <div class="bg-sugih-dark py-3 border-t border-sugih-green/20">
        <div class="container-page flex items-center justify-center gap-3 text-sugih-surface text-xs sm:text-sm font-semibold tracking-wide text-center">
            <i class="fas fa-shield-alt text-sugih-green text-base"></i>
