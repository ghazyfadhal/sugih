    ...
    <div class="container-page flex items-center justify-between h-20">
        ...
        <nav class="hidden lg:flex items-center gap-12" data-testid="nav-desktop">
            <a href="{{ request()->routeIs('home') ? '#top' : route('home') }}"
               class="nav-link {{ request()->routeIs('home') ? 'text-sugih-gold' : 'text-white/90' }}">Beranda</a>
            <a href="{{ route('about') }}"
               class="nav-link {{ request()->routeIs('about') ? 'text-sugih-gold' : 'text-white/90' }}">Sejarah</a>
            <a href="{{ route('products.index') }}"
               class="nav-link {{ request()->routeIs('products.*') ? 'text-sugih-gold' : 'text-white/90' }}">Produk</a>
            <a href="{{ route('articles.index') }}"
               class="nav-link {{ request()->routeIs('articles.*') ? 'text-sugih-gold' : 'text-white/90' }}">Berita</a>
        </nav>
