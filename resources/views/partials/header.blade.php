...
<header
    ...
    :class="scrolled ? 'bg-sugih-ivory/60 backdrop-blur-lg shadow-sm' : 'bg-transparent'"
    ...
    <div class="container-page flex items-center justify-between h-20">
        ...
        <nav class="hidden lg:flex items-center gap-12" data-testid="nav-desktop">
            <a href="{{ request()->routeIs('home') ? '#top' : route('home') }}"
               class="nav-link"
               :class="scrolled ? 'hover:text-sugih-brown {{ request()->routeIs('home') ? 'text-sugih-terracotta' : 'text-sugih-charcoal' }}' : 'hover:text-sugih-gold {{ request()->routeIs('home') ? 'text-sugih-gold' : $defaultText }}'">Beranda</a>
            <a href="{{ route('about') }}"
               class="nav-link"
               :class="scrolled ? 'hover:text-sugih-brown {{ request()->routeIs('about') ? 'text-sugih-terracotta' : 'text-sugih-charcoal' }}' : 'hover:text-sugih-gold {{ request()->routeIs('about') ? 'text-sugih-gold' : $defaultText }}'">Sejarah</a>
            <a href="{{ route('products.index') }}"
               class="nav-link"
               :class="scrolled ? 'hover:text-sugih-brown {{ request()->routeIs('products.*') ? 'text-sugih-terracotta' : 'text-sugih-charcoal' }}' : 'hover:text-sugih-gold {{ request()->routeIs('products.*') ? 'text-sugih-gold' : $defaultText }}'">Produk</a>
            <a href="{{ route('articles.index') }}"
               class="nav-link"
               :class="scrolled ? 'hover:text-sugih-brown {{ request()->routeIs('articles.*') ? 'text-sugih-terracotta' : 'text-sugih-charcoal' }}' : 'hover:text-sugih-gold {{ request()->routeIs('articles.*') ? 'text-sugih-gold' : $defaultText }}'">Berita</a>
        </nav>
        ...
        <button
            ...
            :class="[open ? 'rotate-90' : 'rotate-0', scrolled ? 'text-sugih-charcoal' : '{{ $isLightTop ? 'text-sugih-charcoal' : 'text-sugih-gold' }}']"
