...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.products.create') }}" class="bg-sugih-green-900 text-sugih-gold px-5 py-2.5 rounded-xl font-semibold hover:bg-sugih-green-800 transition-colors flex items-center">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        @if($product->image)
                            <img src="{{ $product->image_url }}" class="w-16 h-16 object-cover rounded-lg border border-gray-200">
                        @else
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="{{ route('admin.products.edit', $product->id) }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
                            Edit
                        </a>
