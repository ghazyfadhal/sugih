...
<div x-data="productReorder({{ $products->firstItem() ?? 1 }})">
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <a x-show="!reorderMode" href="{{ route('admin.products.create') }}" class="bg-sugih-green-900 text-sugih-green px-5 py-2.5 rounded-xl font-semibold hover:bg-sugih-green-800 transition-colors flex items-center shadow-sm">
