...
<form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-4xl">
    @csrf
            ...
            <div>
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-[#E6C981] transition-colors bg-gray-50 relative">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-gray-500">Rekomendasi ukuran: 1200x800px</p>
                    </div>
                </div>
