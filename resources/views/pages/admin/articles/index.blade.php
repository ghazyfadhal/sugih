...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.articles.create') }}" class="bg-sugih-green-900 text-sugih-green px-5 py-2.5 rounded-xl font-semibold hover:bg-sugih-green-800 transition-colors flex items-center">
