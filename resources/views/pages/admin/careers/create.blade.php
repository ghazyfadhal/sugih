...
@section('header', 'Tambah Lowongan Karir')
...
<form action="{{ route('admin.careers.store') }}" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-4xl">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E6C981] focus:border-[#E6C981] outline-none transition-all" placeholder="Contoh: Barista, Social Media Specialist">
            ...
            <div>
                ...
                <input type="text" id="department" name="department" value="{{ old('department') }}" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E6C981] focus:border-[#E6C981] outline-none transition-all" placeholder="Contoh: Operasional, Marketing">
            ...
            <div>
                ...
                <input type="text" id="location" name="location" value="{{ old('location') }}" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E6C981] focus:border-[#E6C981] outline-none transition-all" placeholder="Contoh: Bandung, Indonesia">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea id="requirements" name="requirements" rows="6" required class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#E6C981] focus:border-[#E6C981] outline-none transition-all" placeholder="Tuliskan syarat pendidikan, pengalaman, skill yang dibutuhkan...">{{ old('requirements') }}</textarea>
